...
# ── 3b. Sort languages by their top category's percentage ────────────────────
# Languages with the strongest single-topic focus appear at the top.
pivot_pct = pivot_pct.loc[pivot_pct.max(axis=1).sort_values(ascending=False).index]
...
fig.text(
    0.06, 0.91,
    "Each cell shows what percentage of a language's articles fall into a given category  ·  Sorted by strongest single-category focus",
